...
clip_window='1:1'
peak_thresh='0.00'
divider_clip='black.mp4'
python extract_clips.py $directory/GC5_NAcprojection/list_of_event_times_GC5_NAcprojection_homecagenovel.pkl -o $output --clip-window=$clip_window --peak-thresh=$peak_thresh --divider-clip=$divider_clip
if $(false); then
python extract_clips.py $directory/GC5_NAcprojection/list_of_event_times_GC5_NAcprojection_homecagesocial.pkl -o $output --clip-window=$clip_window --peak-thresh=$peak_thresh  --divider-clip=$divider_clip
python extract_clips.py $directory/GC5/list_of_event_times_GC5_homecagesocial.pkl -o $output --clip-window=$clip_window --peak-thresh=$peak_thresh  --divider-clip=$divider_clip
python extract_clips.py $directory/GC5/list_of_event_times_GC5_homecagenovel.pkl -o $output --clip-window=$clip_window --peak-thresh=$peak_thresh  --divider-clip=$divider_clip
