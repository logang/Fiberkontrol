...
#        self.newPlot.make_restricted_plot(self.coords)
        
        self.make_restricted_plot(self.coords)
...
#        self.ynormFlat = array(self.yflat)/self.newPlot.yinit
        ...
        self.plot = plt.plot(self.xnew, self.ynormFlat, **self.plotArgs)
...
#        self.yflat = self.newPlot.ynew + dIntensity
    ...
    def make_restricted_plot(self, coords):
        x1 = int(coords[1][0])
