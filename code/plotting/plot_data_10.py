...
#----Plot restricted range of data (defined by coords)--#
        ...
        self.make_new_plot(self.coords)
        ...
        self.normalize(self.xnew, self.ynew)
        self.plotNorm = plt.plot(self.xnew, self.ynew, **self.plotArgs)
        ...
        self.plot_hist(axNew, self.mouseLabel)
        plt.draw()
        plt.hold(False)
...
#       y2 = int(self.coords[2][1])
    ...
    def plot_hist(self, ax, mouseLabel):
        self.plotHist = ax.hist(self.ynew, bins=1000, range = (0.85, 1.1), histtype='bar')
